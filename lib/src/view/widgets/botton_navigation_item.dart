...
class BottonNavigationItem extends StatefulWidget {
  final IconData icon;
  final String label;
  final bool selected;
  ...
  @override
  State<BottonNavigationItem> createState() => _BottonNavigationItemState();
}

class _BottonNavigationItemState extends State<BottonNavigationItem> {
